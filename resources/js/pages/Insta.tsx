...
const Insta = ({ }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (mode === 'url') {
            ...
            post(route('fetch-user-insta-medias'), {
                onSuccess: () => {
                    toast.dismiss();
                ...
                onError: (errors) => {
                    if (errors?.username) {
                        ...
                        toast.error('An error occurred while fetching user medias.');
                    }
                }
            });
        }
        ...
        <>
            ...
            <div className="bg-black sm:h-screen h-svh w-screen flex justify-center items-center ">
                <div className="w-11/12 sm:w-4/12 p-6 bg-white shadow-lg rounded-lg">
                    ...
                    <Head title="Instagram Media Downloader" />
                    <h1 className="text-2xl font-bold mb-6 text-center text-gray-900">Instagram Downloader</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 text-gray-900">
                        <div>
                            ...
                            >
                                <option value="url">Single Media (URL)</option>
                                {/* <option value="username">Multiple Media (Username)</option> */}
                            </select>
                        </div>

                        {mode === 'url' && (
                            <div>
                                <label htmlFor="url" className="block text-sm font-medium mb-1">Instagram Media URL:</label>
                                <input
                                    type="text"
                                    id="url"
                                    value={data.url}
                        ...
                        {mode === 'username' && (
                            <div>
                                <label htmlFor="username" className="block text-sm font-medium mb-1">Instagram Username:</label>
                                <input
                                    type="text"
                                    id="username"
                                    value={data.username}
